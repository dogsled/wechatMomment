...
-(void) updateViewConstraints
{
    ...
    [_nickNameLabel autoPinEdge:ALEdgeLeft toEdge:ALEdgeRight ofView:_avaterImageView withOffset:5];
    ...
    [_contentLabel autoPinEdge:ALEdgeBottom toEdge:ALEdgeTop ofView:_shareImageView withOffset:-10];
...
//    [_shareImgsView autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:10 relation:NSLayoutRelationGreaterThanOrEqual];
    ...
    [_comments autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:_shareImageView withOffset:10];
